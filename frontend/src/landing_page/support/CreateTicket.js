  ...
  return (
   <div className="container">
      <div className="row p-5 mt-2 mb-2">
       ...
       <div className="col-4 p-5 mt-2 mb-2">
        <h4 className=""><i class="fa-regular fa-circle-user"></i>
       ...
       <div className="col-4 p-5 mt-2 mb-2">
        <h4 className=""><i class="fa-solid fa-location-arrow"></i>
          Kite
        </h4>
        <a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>Transfer and conversion of securities
IPO
...
Margin Trading Facility (MTF) and Margins
        ...
        <a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>Charts and orders
</a><br/>
        <a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>Alerts and Nudges
</a><br/>
        <a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>General</a>
      </div>
       <div className="col-4 p-5 mt-2 mb-2">
        <h4 className=""><i class="fa-solid fa-indian-rupee-sign"></i>
          Funds
        </h4>
